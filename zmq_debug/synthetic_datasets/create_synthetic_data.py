...
flarge_data=neo.RawBinarySignalIO(Path('data/open_ephys_data_544ch_30sec_synthetic/continuous/stream1/continuous.dat').expanduser())
flarge_data.write_segment(segl)
flarge_data


from open_ephys.analysis.formats import BinaryRecording
BinaryRecording.create_oebin_file(Path('data/open_ephys_data_544ch_30sec_synthetic/').expanduser(),
                                  stream_name='stream1',
